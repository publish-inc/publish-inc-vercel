...
DEFAULT_CONTENT = {
    ...
    "about": {
        ...
        "points": [
            "Pengurusan ISBN Resmi Perpustakaan Nasional",
            "Tim Editor & Layouter Profesional Berpengalaman",
            "Cetak Berkualitas Tinggi Presisi & Tepat Waktu",
            "Distribusi & Promosi Marketplace Nasional",
        ],
        "image": "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=800&q=80",
    },
    "services": [
        {"icon": "BookOpen", "title": "Penerbitan Buku Reguler & Cetak", "description": "Paket penerbitan lengkap dengan fasilitas ISBN, editing, layout, dan cetak.", "image": "", "link": "#paket-penerbitan"},
        {"icon": "PenTool", "title": "Konversi Karya Ilmiah", "description": "Ubah skripsi, tesis, atau disertasi menjadi buku referensi ber-ISBN.", "image": "", "link": "#paket-konversi"},
        {"icon": "Megaphone", "title": "Promosi & Distribusi", "description": "Bantu promosi buku ke marketplace dan jaringan toko buku nasional.", "image": "", "link": "#buku-pilihan"},
        {"icon": "GraduationCap", "title": "Penerbitan Buku Ajar / Dosen", "description": "Layanan khusus buku ajar, monograf, dan buku referensi akademik.", "image": "", "link": "#layanan"},
    ],
    "stats": [
        {"value": "1,500+", "number": "1,500+", "label": "Judul Buku Diterbitkan"},
        {"value": "1,200+", "number": "1,200+", "label": "Penulis & Dosen Terdaftar"},
        {"value": "99.8%", "number": "99.8%", "label": "Kepuasan Pelanggan"},
        {"value": "50+", "number": "50+", "label": "Kota Jangkauan Distribusi"},
    ],
    "packages_penerbitan": {
        "eyebrow": "PAKET PENERBITAN",
        "title": "Pilihan Paket Terbit Sesuai Kebutuhan",
        "description": "Pilih paket penerbitan buku yang paling tepat untuk karya Anda.",
        "items": [
            {
                "name": "Paket Hemat",
                "price": "Rp 1.499.000",
                "description": "Solusi terjangkau untuk menerbitkan buku pertama Anda.",
                "features": ["Pendaftaran ISBN Resmi", "Tata Letak (Layout) Standar", "Desain Cover Simple", "Bukti Cetak 2 Eksemplar", "Sertifikat Penulis"],
                "popular": False,
                "image": "",
            },
            {
                "name": "Paket Reguler",
                "price": "Rp 2.999.000",
                "description": "Paket favorit bagi penulis & akademisi.",
                "features": ["Pendaftaran ISBN Resmi", "Sub-editing & Proofreading", "Layout Executive", "Desain Cover Premium 3D", "Bukti Cetak 5 Eksemplar", "Promosi Marketplace & Sosmed"],
                "popular": True,
                "image": "",
            },
            {
                ...
                "price": "Rp 4.999.000",
                "description": "Layanan super komplit untuk hasil publikasi sempurna.",
                "features": ["Pendaftaran ISBN Resmi", "Full Proofreading & Editing", "Custom Layout & Ilustrasi", "Desain Cover Exclusive", "Bukti Cetak 10 Eksemplar", "Press Release & Promosi Toko Online"],
                "popular": False,
                "image": "",
            },
        ],
    ...
    "packages_konversi": {
        "eyebrow": "PAKET KONVERSI",
        "title": "Konversi Karya Tulis Ilmiah Menjadi Buku",
        "description": "Ubah skripsi, tesis, disertasi, atau laporan penelitian Anda menjadi buku ber-ISBN.",
        "items": [
            {
                "name": "Konversi Skripsi / Tesis",
                "price": "Rp 1.999.000",
                "description": "Format ulang karya ilmiah menjadi gaya bahasa populer & akademis.",
                "features": ["Restrukturisasi Bab Ilmiah", "Pendaftaran ISBN Resmi", "Editing Bahasa & Layout", "Desain Cover Profesional", "Bukti Cetak 3 Eksemplar"],
                "popular": True,
                "image": "",
            },
            {
                "name": "Konversi Disertasi / Monograf",
                "price": "Rp 3.499.000",
                "description": "Konversi komprehensif untuk disertasi & hasil penelitian besar.",
                "features": ["Restrukturisasi & Peer-review Internal", "Pendaftaran ISBN Resmi", "Full Editing & Layouting", "Cover Custom Premium", "Bukti Cetak 5 Eksemplar"],
                "popular": False,
                "image": "",
            },
        ],
    ...
    "packages_cetak": {
        "eyebrow": "PAKET CETAK",
        "title": "Cetak Buku Kuantitas Fleksibel",
        "description": "Cetak naskah yang sudah siap dengan kualitas kertas & jilid terbaik.",
        "items": [
            {
                "name": "Cetak Print-on-Demand (POD)",
                "price": "Mulai Rp 25.000 / eks",
                "description": "Cetak tanpa minimum order, pas untuk kebutuhan terbatas.",
                "features": ["Kertas Bookpaper / HVS", "Softcover Laminasi Doff/Glossy", "Jilid Lem Panas (Perfect Binding)", "Minimal order 5 eksemplar"],
                "popular": True,
                "image": "",
            },
            {
                "name": "Cetak Komunitas / Jumlah Besar",
                "price": "Harga Khusus Grosir",
                "description": "Cetak di atas 100 eksemplar dengan diskon spesial.",
                "features": ["Pilihan Kertas Custom", "Hardcover / Softcover", "Shrink Wrap / Plastik Pelindung", "Pengiriman Cargo Murah"],
                "popular": False,
                "image": "",
            },
        ],
    ...
    "packages_ebook": {
        "eyebrow": "TERBIT EBOOK",
        "title": "Publikasi Digital & Ebook",
        "description": "Jangkau pembaca digital melalui platform ebook terkemuka.",
        "items": [
            {
                "name": "Paket Ebook Digital",
                "price": "Rp 999.000",
                "description": "Format PDF & EPUB terlindungi DRM.",
                "features": ["e-ISBN Resmi", "Konversi Format EPUB & PDF", "Desain Cover Digital", "Distribusi ke Google Play Books / Store"],
                "popular": True,
                "image": "",
            },
        ],
    ...
    "promo": {
        "eyebrow": "INFO PROMO",
        "title": "Penawaran & Diskon Spesial",
        "description": "Dapatkan penawaran terbatas untuk penerbitan buku bulan ini.",
        "items": [
            {
                "title": "Promo Diskon Awal Tahun",
                "badge": "DISCOUNT 20%",
                "description": "Diskon 20% untuk semua paket penerbitan reguler selama bulan ini.",
                "image": "",
            },
            {
                "title": "Gratis Pengurusan ISBN & e-ISBN",
                "badge": "GRATIS",
                "description": "Setiap pengambilan Paket Reguler atau Eksklusif mendapatkan gratis biaya pendaftaran ISBN.",
                "image": "",
            },
        ],
    },
    "testimonials": [
        {"name": "Dr. Ahmad Hidayat, M.Pd.", "role": "Dosen Universitas Negeri", "quote": "Proses penerbitan buku ajar saya sangat cepat dan komunikatif. Hasil cetak dan layout sangat rapi!", "content": "Proses penerbitan buku ajar saya sangat cepat dan komunikatif. Hasil cetak dan layout sangat rapi!", "rating": 5},
        {"name": "Siti Nurhaliza, S.T.", "role": "Penulis Buku Populer", "quote": "Tim Publish Inc. sangat membantu dari proses editing hingga pendaftaran ISBN. Rekomended banget!", "content": "Tim Publish Inc. sangat membantu dari proses editing hingga pendaftaran ISBN. Rekomended banget!", "rating": 5},
    ],
    "contact": {
        "eyebrow": "KONTAK KAMI",
        "title": "Ada Pertanyaan atau Ingin Konsultasi?",
        "description": "Tim kami siap membantu Anda dari awal penyuntingan hingga buku diterbitkan.",
    ...
    "faq": {
        ...
        "items": [
            {"question": "Berapa lama proses penerbitan buku di Publish Inc.?", "answer": "Proses penerbitan standar memakan waktu 14 hingga 30 hari kerja tergantung pada paket yang dipilih dan kecepatan proses revisi dari penulis."},
            {"question": "Apakah pendaftaran ISBN dilakukan secara resmi?", "answer": "Ya, seluruh pendaftaran ISBN dilakukan secara resmi melalui Perpustakaan Nasional RI (Perpusnas)."},
            {"question": "Apakah saya mempertahankan hak cipta naskah saya?", "answer": "Tentu saja! Hak cipta 100% tetap menjadi milik Anda sebagai penulis. Publish Inc. hanya bertindak sebagai fasilitator penerbitan & percetakan."},
            {"question": "Bagaimana cara mendistribusikan buku saya ke toko online?", "answer": "Kami menyediakan opsi distribusi ke toko online resmi Publish Inc., Tokopedia, Shopee, dan platform ebook digital."},
        ],
    },
    "section_visibility": {
        "rekap": True,
